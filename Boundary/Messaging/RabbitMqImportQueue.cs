...
public class RabbitMqImportQueue(RabbitMqPersistentConnection persistentConnection) : IImportQueue
{
    private const string QueueName = "import.jobs";

    public async Task PublishAsync(ImportJobMessage message)
    {
