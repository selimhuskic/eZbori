...
public class RabbitMqUserInviteQueue(RabbitMqPersistentConnection persistentConnection) : IUserInviteQueue
{
    private const string QueueName = "user.invited";

    public async Task PublishAsync(UserInviteMessage message)
    {
