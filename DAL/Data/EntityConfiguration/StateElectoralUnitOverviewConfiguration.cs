...
{
    public class StateElectoralUnitOverviewConfiguration : IEntityTypeConfiguration<StateElectoralUnitOverview>
    {
        public void Configure(EntityTypeBuilder<StateElectoralUnitOverview> builder)
        {
            builder.ToTable("StateElectoralUnitOverview", "elections").HasKey(x => x.Id);
