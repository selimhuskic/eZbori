...
{
    internal class PresidencyMunicipalResultsConfiguration : IEntityTypeConfiguration<PresidencyMunicipalResults>
    {
        public void Configure(EntityTypeBuilder<PresidencyMunicipalResults> builder)
        {
            builder.ToTable("PresidencyMunicipalResults", "elections").HasKey(x => x.Id);
