...
{
    public class CantonElectoralUnitOverviewConfiguration : IEntityTypeConfiguration<CantonElectoralUnitOverview>
    {
        public void Configure(EntityTypeBuilder<CantonElectoralUnitOverview> builder)
        {
            builder.ToTable("CantonElectoralUnitOverview", "elections").HasKey(x => x.Id);
