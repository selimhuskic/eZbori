...
{
    public class EntityPresidentOverviewConfiguration : IEntityTypeConfiguration<EntityPresidentOverview>
    {
        public void Configure(EntityTypeBuilder<EntityPresidentOverview> builder)
        {
            builder.ToTable("EntityPresidentOverview", "elections").HasKey(x => x.Id);
            ...
            builder.Property(x => x.BasicInfoId).HasColumnType("int").IsRequired();
            builder.Property(x => x.ConfirmedVotes).HasColumnType("int").IsRequired();
            builder.Property(x => x.DataFrom).HasColumnType("datetime2").IsRequired();
            ...
            builder.Property(x => x.NumberOfMunicipalities).HasColumnType("int").IsRequired();
