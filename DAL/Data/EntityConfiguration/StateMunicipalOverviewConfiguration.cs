...
{
    public class StateMunicipalOverviewConfiguration : IEntityTypeConfiguration<StateMunicipalOverview>
    {
        public void Configure(EntityTypeBuilder<StateMunicipalOverview> builder)
        {
            builder.ToTable("StateMunicipalOverview", "elections").HasKey(x => x.Id);
