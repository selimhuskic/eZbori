...
{
    public class EntityElectoralUnitPartyConfiguration : IEntityTypeConfiguration<EntityElectoralUnitParty>
    {
        public void Configure(EntityTypeBuilder<EntityElectoralUnitParty> builder)
        {
            builder.ToTable("EntityElectoralUnitParty", "elections").HasKey(x => x.Id);
