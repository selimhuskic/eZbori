...
{
    public class MunicipalityCouncilMinorityConfiguration : IEntityTypeConfiguration<MunicipalityCouncilMinority>
    {
        public void Configure(EntityTypeBuilder<MunicipalityCouncilMinority> builder)
        {
            builder.ToTable("MunicipalityCouncilMinority", "elections").HasKey(x => x.Id);
