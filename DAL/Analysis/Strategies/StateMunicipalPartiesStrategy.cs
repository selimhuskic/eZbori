...
public sealed class StateMunicipalPartiesStrategy(eZboriDbContext dbContext) : IPartiesResultsStrategy
{
    public AnalysisSubject Subject => AnalysisSubject.StateMunicipalParties;

    public async Task<IEnumerable<PartiesResults>> GetAsync(AnalysisRequest request, CancellationToken ct)
        => await (from o in dbContext.StateMunicipalParty
                  ...
                  select new PartiesResults(
                      ...
                      AnalysisSubject.StateMunicipalParties,
                      0, o.Code, 0, 0,
                      o.Name,
                      o.Percentage,
                      0, 0, 0,
